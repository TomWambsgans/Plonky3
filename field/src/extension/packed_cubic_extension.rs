...
impl<F: Field, PF: PackedField<Scalar = F>>
    Distribution<PackedCubicTrinomialExtensionField<F, PF>> for StandardUniform
where
...
impl<F, PF> AddAssign<CubicTrinomialExtensionField<F>>
    for PackedCubicTrinomialExtensionField<F, PF>
where
    F: CubicTrinomialExtendable,
    PF: PackedField<Scalar = F>,
...
impl<F, PF> SubAssign<CubicTrinomialExtensionField<F>>
    for PackedCubicTrinomialExtensionField<F, PF>
where
    F: CubicTrinomialExtendable,
    PF: PackedField<Scalar = F>,
...
impl<F, PF> MulAssign<CubicTrinomialExtensionField<F>>
    for PackedCubicTrinomialExtensionField<F, PF>
where
    F: CubicTrinomialExtendable,
    PF: PackedField<Scalar = F>,
...
impl<F, PF> Product<CubicTrinomialExtensionField<F>>
    for PackedCubicTrinomialExtensionField<F, PF>
where
    F: CubicTrinomialExtendable,
    PF: PackedField<Scalar = F>,
...
impl<F, PF> DivAssign<CubicTrinomialExtensionField<F>>
    for PackedCubicTrinomialExtensionField<F, PF>
where
    F: CubicTrinomialExtendable,
    PF: PackedField<Scalar = F>,
    ...
    PF: PackedField<Scalar = F>,
{
    ...
    fn div(self, rhs: Self) -> Self {
        let mut rhs_inv = Self::broadcast(CubicTrinomialExtensionField::<F>::ZERO);
